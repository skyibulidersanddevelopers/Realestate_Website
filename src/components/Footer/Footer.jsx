      ...
      <div className="footer-bottom">
        ...
        <div className="footer-col brand-col">
          ...
          <p className="footer-desc">
            Experience unparalleled luxury and serenity. We bring you the finest real estate solutions designed to elevate your lifestyle.
          </p>
          ...
          <div className="footer-contact-item">
            ...
            <span>info@skyibuilders.com</span> */}
          </div>
        </div>
