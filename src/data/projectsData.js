...
export const projectsData = [
  {
    id: 'project1',
    title: 'SKYi MERIDIAN HEIGHTS',
    shortDesc: 'Luxury Lifestyle Villas — Sarjapur Road, Bangalore East',
    ...
    bankLoans: 'HDFC | SBI',
    description: 'A private enclave offering complete living infrastructure with extensive landscaping, dedicated recreation zones, parks and play areas. A well designed road network with tree lined avenues and pedestrian walkways, optimized to provide a secure and serene living environment.',
  },
  {
    id: 'project2',
    title: 'SKYi ENCLAVE PRIME',
    shortDesc: 'Premium Villa Plots — Between Whitefield & Hoskote, Bangalore',
    date: 'Completed: 4th November 2025',
    image: p2_1_thumb,
    bannerImage: p2_1,
    images: [p2_1, p2_2, p2_3, p2_4],
    offering: 'Premium Villa Plots from Rs.1.20 Cr*',
    status: 'BMRDA Approved | Fully Delivered',
    bankLoans: 'ICICI | Axis Bank',
    description: 'Located strategically near the upcoming Satellite Town Ring Road (STRR), this enclave offers premium villa plots with world-class infrastructure. Perfect for those looking to build their dream home in a rapidly appreciating location.',
  },
  {
    id: 'project3',
    title: 'SKYi SERENE MEADOWS',
    shortDesc: 'Villa Plots — 1 Km off Bangalore Hosur Road, near Chandapura',
    ...
    description: 'A serene plotted development just off the bustling Hosur Road. SKYi Serene Meadows combines the peace of countryside living with the convenience of city life. Fully developed with tar roads, underground electricity, and water connections.',
  },
  {
    id: 'project4',
    title: 'SKYi NEXUS TOWERS',
    shortDesc: 'Luxury Apartments — Electronic City Phase 1, Bangalore',
    ...
    description: 'Experience high-rise luxury living right in the heart of Electronic City. SKYi Nexus offers smartly designed homes with premium finishes and state-of-the-art amenities including a rooftop sky lounge with panoramic city views.',
  },
  {
    id: 'project5',
    title: 'SKYi WOODLAND VISTAS',
    shortDesc: 'Eco-friendly Villas — Nestled in Nature, Kanakapura Road',
    ...
    description: 'Embrace sustainable living at SKYi Woodland Vistas. These eco-friendly villas are designed to minimize carbon footprint while maximizing luxury. Features include solar heating, rainwater harvesting, and organic gardens within a lush forested community.',
  },
  {
    id: 'project6',
    title: 'SKYi HARMONY RESIDENCES',
    shortDesc: 'Premium Row Houses — Yelahanka New Town, North Bangalore',
    date: 'Completed: 30th September 2025',
    image: p6_1_thumb,
    bannerImage: p6_1,
    images: [p6_1, p6_2, p6_3, p6_4],
    offering: '3 BHK Premium Row Houses',
    status: 'Ready to Move In',
    bankLoans: 'HDFC | SBI',
    description: 'SKYi Harmony brings the concept of elegant row houses to North Bangalore. Enjoy the privacy of an independent home with the security and amenities of a gated community. Each home comes with a private garden and exclusive club access.',
  },
  {
    id: 'project7',
    title: 'SKYi PINNACLE ESTATES',
    shortDesc: 'Ultra-Luxury Villas — Devanahalli, Aerospace SEZ Zone',
    date: 'The project is yet to be announced',
    image: p7_1_thumb,
    bannerImage: p7_1,
    ...
    description: 'The pinnacle of luxury living near the Kempegowda International Airport. SKYi Pinnacle Estates offers ultra-luxury villas with private pools, smart home automation, and breathtaking views of the Nandi Hills — an address that defines prestige.',
  },
];
